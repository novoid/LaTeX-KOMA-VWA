...
*** Deutsche Anführungszeihen statt umgekehrt französischer

Wenn du lieber „das“ statt »der Standardanführungszeichen« haben
möchtest, so kannst du in ~template/typographic_settings.tex~ die
Zeile:
